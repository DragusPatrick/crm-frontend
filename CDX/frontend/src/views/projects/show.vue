<template>
    <div class="row">
        <div class="col-md-8">
            <div id="view-project" class="card d-block">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-4">
                                <h5>Start Date</h5>
                                <p style="color: #6C757D;font-weight: 600;">{{ project.start_date | formatMiniDate }} <small class="text-muted">1:00 PM</small></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-4">
                                <h5>End Date</h5>
                                <p style="color: #6C757D;font-weight: 600;">{{ project.due_date | formatMiniDate }} <small class="text-muted">1:00 PM</small></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-4">
                                <h5>Budget</h5>
                                <p style="color: #6C757D;font-weight: 600;">$ {{ project.budget | formatMoney }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Mat Helme" class="d-inline-block">
                            <img src="https://coderthemes.com/hyper/saas/assets/images/users/avatar-6.jpg" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>
                        ...
                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Michael Zenaty" class="d-inline-block">
                            <img src="https://coderthemes.com/hyper/saas/assets/images/users/avatar-7.jpg" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>
                        ...
                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="James Anderson" class="d-inline-block">
                            <img src="https://coderthemes.com/hyper/saas/assets/images/users/avatar-8.jpg" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>

                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Mat Helme" class="d-inline-block">
                            <img src="https://coderthemes.com/hyper/saas/assets/images/users/avatar-4.jpg" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>

                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Michael Zenaty" class="d-inline-block">
                            <img src="https://coderthemes.com/hyper/saas/assets/images/users/avatar-5.jpg" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>

                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="James Anderson" class="d-inline-block">
                            <img src="https://coderthemes.com/hyper/saas/assets/images/users/avatar-3.jpg" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-right">
                        ...
                        <div class="btn-group mb-2 ml-2">
                            <button type="button" class="btn btn-purple  btn-sm">Submit</button>
                        </div>
                    </div>

                    <div class="media mt-2">
                        <img class="mr-3 avatar-sm rounded-circle" src="https://coderthemes.com/hyper/saas/assets/images/users/avatar-3.jpg" alt="Generic placeholder image">
                        <div class="media-body">
                            ...
                            <div class="media mt-3">
                                <a class="pr-3" href="#">
                                    <img src="https://coderthemes.com/hyper/saas/assets/images/users/avatar-4.jpg" class="avatar-sm rounded-circle" alt="Generic placeholder image">
                                </a>
                                <div class="media-body">
                ...
                <div class="card-body">
                    ...
                    <div class="card mb-1 shadow-none border">
                        <div class="p-2">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <img src="https://coderthemes.com/hyper/saas/assets/images/projects/project-1.jpg" class="avatar-sm rounded" alt="file-image">
                                </div>
                                <div class="col pl-0">
