<template>
    <div class="filterable">
            ...
            <div class="panel-heading">
                ...
                <div class="panel-extra">
                    <div style="display: flex;">
                        <div>
                            <router-link :to="{ path: this.$route.meta.href+'/create'}" class="btn btn-primary" style="color: #fff;">
                ...
                <div class="filters">
                    <div class="filters-item" v-for="(f, i) in filterCandidates">
                        ...
                        <div class="filters-remove-wrap" v-if="f">
                            <button class="filters-remove" @click="removeFilter(f, i)">
            ...
            <div class="panel-footer">
                <div class="filters-control">
                    <div class="filter-controls">
                        ...
                        <div class="filters-control-item" v-if="this.appliedFilters.length > 0">
        ...
        <div class="filterable-mid">
            <div>
                <button data-toggle="modal" data-target="#exampleModal" type="button" class="btn btn-default btn-sm">
            ...
            <div style="display: inline; width: 11%;">
                <span>Order by:</span>
                <select :disabled="loading" @input="updateOrderColumn" class="filterable-sort form-input form-input-sm">
        ...
        <div class="panel">
            ...
            <div class="panel-footer">
                <div class="flex flex-between" style="width: 100%;">
                    <div>
                        <select class="form-input form-input-sm" v-model="query.limit" :disabled="loading" @change="updateLimit" style="width:21%;">
                            <option>10</option>
                            <option>15</option>
                            <option>20</option>
                            <option>25</option>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row" style="display:flex;">
                            <div class="col-6">
                                <a href="/api/exports/invoices?sort_column=created_at&amp;sort_direction=desc&amp;filter_match=and&amp;limit=10&amp;page=1" class="export-link">
                    ...
                    <div class="modal-footer">
                        ...
                        <div>
                            <button type="button" class="btn btn-default"><!----> <span class="btn-text">Cancel</span> <!----></button>
                        </div>
                    </div>
                </div>
            </div>
